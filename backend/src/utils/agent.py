...
from utils.tools import get_commend,get_files,excute_command
from langchain.messages import SystemMessage,HumanMessage,AIMessage  # TODO: 导入了 HumanMessage, AIMessage 但从未使用
...
# 需要知道执行命令的传入文件和传出文件位置，对于命令的情况进行反馈
...
agent_chat = create_agent(
    ...
    # tools=  # TODO: tools= 被注释。如果 chat 需要查询文件列表等能力，也应绑定对应工具
)